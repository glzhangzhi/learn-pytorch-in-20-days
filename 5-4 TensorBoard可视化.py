'''
在TensorBoard中可视化的大概流程
1.在pytorch中指定一个目录创建一个torch.utils.tensorboard.SummaryWriter日志写入器
2.根据需要可视化的信息，利用日志写入器将响应信息日志写入我们指定的目录
3.传入日志目录作为Tensorboard参数，进行可视化操作
'''
